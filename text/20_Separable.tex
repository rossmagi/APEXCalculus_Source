...
\mnote{.35}{\textbf{Note:} Solving for $y$ initially yields the explicit solution $\displaystyle y = \frac{AMe^{kt}}{1+Ae^{kt}}$. Dividing numerator and denominator by $Ae^{kt}$ and defining $b = 1/A$ yields the commonly presented form of the solution given in example \ref{ex_logistic}.}
