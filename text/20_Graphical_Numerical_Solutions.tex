...
Find an approximation at $x=2$ for the solution to $\yp = x + y$ with $y(1)=-1$ using Euler's Method with $h=0.25$.
}
...
\mfigure{.8}{Euler's Method approximations to $\yp = x + y$ with $y(1) = -1$ from examples \ref{ex_euler1} and \ref{ex_euler2}, along with the analytical solution.}{fig:20_01_euler2}{figures/fig20_01_euler2}
