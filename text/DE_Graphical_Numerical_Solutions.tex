...
\mfigure{.475}{Euler's Method approximations to $y' = x + y$ with $y(1) = -1$ from examples \ref{ex_euler1} and \ref{ex_euler2}, along with the analytical solution.}{fig:DE_01_ex_8}{figures/figDE_01_ex_8}
