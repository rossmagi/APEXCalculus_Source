...
The solution to a differential that encompasses all possible solutions is called the \textbf{general solution} to the differential equation. A general solution includes one or more arbitrary constants.
}\\
...
\mfigure{.8}{Slope field for $y' = x+y$ from example \ref{ex_slope_field}.}{fig:DE_01_ex_4}{figures/figDE_01_ex_4}
...
\mfigure{.6}{Solution to the initial value problem $y' = x+y$ with $y(1)=-1$ from example \ref{ex_IVP_graphical}}{fig:DE_01_ex_5}{figures/figDE_01_ex_5}


\mfigure{.375}{Slope field for the logistic differential equation $y' = y(1-y)$ from example \ref{ex_logistic_slope_field}.}{fig:DE_01_ex_6a}{figures/figDE_01_ex_6a}
...
\mfigure{.8}{Euler's Method approximation to $y' = x + y$ with $y(1) = -1$ from example \ref{ex_euler1}, along with the analytical solution to the initial value problem.}{fig:DE_01_ex_7}{figures/figDE_01_ex_7}
...
\mfigure{.45}{Euler's Method approximations to $y' = x + y$ with $y(1) = -1$ from examples \ref{ex_euler1} and \ref{ex_euler2}, along with the analytical solution.}{fig:DE_01_ex_8}{figures/figDE_01_ex_8}
...
\mfigure{.8}{Euler's Method approximation to $y' = y(1-y)$ with $y(0) = 0.25$ from example \ref{ex_euler3}, along with the analytical solution.}{fig:DE_01_ex_9}{figures/figDE_01_ex_9}
