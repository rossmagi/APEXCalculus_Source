...
%\mfigure{.8}{A few representative arrows in the slope field for $y' = x+y$}{fig:DE_01_ex_4a}{figures/figDE_01_ex_4a}
...
\mfigure{.5}{Solution to the initial value problem $y' = x+y$ with $y(1)=-1.$}{fig:DE_01_ex_5}{figures/figDE_01_ex_5}

\example{ex_logistic_slope_field}{Using a slope field to predict long term behavior}{
Use the slope field for the differential equation $y' = y(1-y)$, shown in figure \ref{fig:DE_01_ex_6}, to predict long term behavior of solutions to the equation.}
{

}

\mfigure{.2}{Solution to the initial value problem $y' = x+y$ with $y(1)=-1.$}{fig:DE_01_ex_6}{figures/figDE_01_ex_6}
