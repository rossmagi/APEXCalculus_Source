...
\mfigure{.4}{The velocity functions from examples \ref{ex_falling_object} (dashed) and \ref{ex_falling_object1} (solid) under the assumption that $v(0)=0$, with $g=9.8, m=1,$ and $k=1.$}{fig:20_03_falling_object}{figures/fig20_03_falling_object}
